...
// fragment shader that renders the shading model for wood
// most inspiration from the original paper and Renderman shader by Marschner et al.
// some inspiration by an Nvidia white-paper (for the fresnel function)
